...
export default function Privacidad() {
  return (
    <div style={{ maxWidth: 800, margin: "0 auto", padding: 32 }}>
      ...
      <p>
        No cedemos tus datos a terceros, salvo obligación legal o para la prestación del servicio (proveedores de hosting, email, formularios, sistemas de pago, y herramientas necesarias para la actividad, siempre bajo contrato de confidencialidad y cumpliendo el RGPD).<br />
        Actualmente trabajamos con proveedores como: EmailJS (gestión de formularios), Google Workspace (correo y almacenamiento), [AÑADE LOS QUE USES].<br />
      ...
      <p>
        En ANTEA adoptamos todas las medidas técnicas y organizativas razonables para proteger tus datos y evitar su alteración, pérdida, acceso o tratamiento no autorizado.
      ...
      <p>
        ANTEA se reserva el derecho de modificar esta política de privacidad para adaptarla a novedades legislativas o jurisprudenciales. Se recomienda revisarla periódicamente. <br />
